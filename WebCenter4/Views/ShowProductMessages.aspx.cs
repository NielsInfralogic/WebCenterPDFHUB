...
namespace WebCenter4.Views
{
	...
	/// </summary>
	public class ShowProductMessages : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
            ...
            SetRadToolbarLabel("Item1", "LblMessages", Global.rm.GetString("txtMessages"));
		...
		private bool GetAllMessages()
		{
			...
			DataTable dt = 
				db.GetMessages((string)Session["UserName"],   Globals.GetIDFromName("PublicationNameCache",
				(string)Session["SelectedPublication"]),(DateTime)Session["SelectedPubDate"], false, out errmsg);
			if (dt == null || errmsg != "")
			{
		...
		private void DataGrid1_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
				...
				(e.Item.ItemType == ListItemType.SelectedItem))
			{
				...
				string s = e.Item.Cells[8].Text;
				// s : Severity*2+IsRead


				bool unread = false;
				if (s == "1" || s == "3")	// read mail
				{
					img.ImageUrl = "../Images/mailread.gif";
					
				}
				else if (s == "2") // severe unread
				{
					unread = true;
