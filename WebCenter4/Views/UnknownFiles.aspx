<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnknownFiles.aspx.cs" Inherits="WebCenter4.Views.UnknownFiles" %>
	...
	<body onscroll="GetScrollPosition()" onresize="GetBrowserDim()">
		...
		<form id="Form1" method="post" runat="server">
            ...
            <telerik:RadToolBar ID="RadToolBar1" Runat="server" Skin="Office2010Blue" style="width: 100%;" OnButtonClick="RadToolBar1_ButtonClick">
                ...
                <telerik:RadToolBarButton runat="server" Value="Retry" Text="Retry" ImageUrl="../Images/reimage16.gif"  Tooltip="Retry selected file(s)" PostBack="true" ImagePosition="Left"  >
                </telerik:RadToolBarButton>
                <telerik:RadToolBarButton runat="server" Value="Delete" Text="Delete" ImageUrl="../Images/waste16.gif"  ToolTip="Delete selected file(s)" PostBack="true" ImagePosition="Left">
                </telerik:RadToolBarButton>
                <telerik:RadToolBarButton runat="server" Value="Rename" Text="Rename" ImageUrl="../Images/edit16.gif" ImagePosition="Left" ToolTip="Rename and retry selected file(s)" PostBack="true"  >
                </telerik:RadToolBarButton>
            </Items>
        </telerik:RadToolBar>
        <div id="mainDiv" style="overflow: Auto;background-color: #f0f8ff;width: 100%;">
			<asp:datagrid id="DataGrid1" runat="server" Font-Size="10pt" Font-Names="Verdana" BorderStyle="None"
				...
				<Columns>
					...
					<asp:BoundColumn DataField="InputFolder" SortExpression="InputFolder" HeaderText="InputFolder"></asp:BoundColumn>
					<asp:BoundColumn DataField="FileTime" SortExpression="FileTime" HeaderText="FileTime"></asp:BoundColumn>
				</Columns>
