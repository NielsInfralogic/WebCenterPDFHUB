<%@ Page language="c#" Codebehind="Flatview3.aspx.cs" AutoEventWireup="false" Inherits="WebCenter4.Views.Flatview3" %>
            ...
            <asp:ScriptManager ID="ScriptManager1" runat="server"> </asp:ScriptManager>
                                ...
                                <table id="TableFlats" runat="server" style="background: #f0f4f8;border:inset; border-color: #7a96df #b0c4de #6495ed #7a96df;"  cellspacing="0" cellpadding="0" width="<%# nImageWidth %>" align="center">
							        <tr>
								        <td style="background: #f0f4f8; vertical-align: top;text-align:center; height:18px;" align="center">
                                            <asp:Panel id="pnlHeader" runat="server" BackColor="#F0F4F8" Font-Names="Verdana" Font-Size="8pt"
												   Height="18" EnableViewState="False" Font-Bold="True">
							        ...
							        <tr>
								        <td style="background-color: #f0f4f8; vertical-align: top;text-align:center;" align="center">
									        <a href='Flatview3.aspx?<%# DataBinder.Eval(Container.DataItem, "ImageQueryString") %>'>
										        <img id='<%# DataBinder.Eval(Container.DataItem, "ImageNumber") %>' title="<%# tooltipClickImage %>" height='<%# nImageHeight %>' src='<%# DataBinder.Eval(Container.DataItem, "ImageName") %>' width="<%# nImageWidth %>"  align="middle" border="0" alt="" onclick="GetScrollPosition();" />
									        </a>
								        </td>
							        </tr>
							        <tr>
								       <td style="vertical-align: top;text-align:center;" align="center">
                                        <asp:Panel id="pnlBottom2" runat="server" EnableViewState="True" >
			    ...
			    <telerik:RadWindowManager id="RadWindowManager1" runat="server" Skin="Vista">
				    <Windows>
				        ...
				        <telerik:RadWindow runat="server" Height="250px" Width="500" SkinsPath="~/RadControls/Window/Skins" ID="radWindowReleaseAll"
