<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeChannels.aspx.cs" Inherits="WebCenter4.Views.ChangeChannels" %>
            ...
            <telerik:RadToolBar ID="RadToolBar1" Runat="server" Skin="Office2010Blue" style="width: 100%;">
                <Items>
                    <telerik:RadToolBarButton runat="server" Value="Item1">
                        <ItemTemplate>
                            <asp:Label ID="LabelChangeChannelsHeader" runat="server" Text="Change Channels/Destinations" CssClass="RadToolbarLabel"></asp:Label>
                        </ItemTemplate>
