...
namespace WebCenter4.Views
{
	...
	/// </summary>
	public partial class PlanViewExtendedXML : System.Web.UI.Page
	{
		...
		protected void SetLanguage()
		{
            ...
            lblSection1.Text = Global.rm.GetString("txtSection") + " 1: " + Global.rm.GetString("txtNumberOfPages");
            lblSection2.Text = Global.rm.GetString("txtSection") + " 2: " + Global.rm.GetString("txtNumberOfPages");
            lblSection3.Text = Global.rm.GetString("txtSection") + " 3: " + Global.rm.GetString("txtNumberOfPages");
        ...
        private void SavePagePlanXML(bool overwriteconfirmed)
        {
            ...
            for (int sec = 1; sec <= 3; sec++)
            {
                ...
                int thispageCount = Globals.TryParse(RadComboBoxPagecount1.SelectedValue, 2);
                if (sec == 2)
                {
