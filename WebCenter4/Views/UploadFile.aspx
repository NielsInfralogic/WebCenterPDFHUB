<%@ Page language="c#" Codebehind="UploadFile.aspx.cs" AutoEventWireup="true" Inherits="WebCenter4.Views.UploadFile" %>
...
<html>
	...
	<body>
		<form id="Form1" method="post" runat="server" encType="multipart/form-data" >
            ...
            <TABLE style="width: 500px" id="Table1" border="0" cellSpacing="1" cellPadding="1" width="500" align="left">
				<TR>
					<TD class="style2"><asp:label id="lblTemplate" runat="server" CssClass="HeaderText">File to upload</asp:label></TD>
					<TD class="style3"><INPUT id="FileData" name="FileData" type="file" runat="server"></TD>
				</TR>
				<TR>
					<TD class="style2"><asp:label id="Label1" runat="server" CssClass="HeaderText">Filename</asp:label></TD>
				...
				<TR>
					<TD colSpan="2" class="style3"><asp:label id="lblInfo2" runat="server" CssClass="LabelNormal"></asp:label>
                        <asp:Label ID="lblFolder" runat="server" Visible="False"></asp:Label>
                    </TD>
				</TR>
				<TR>
