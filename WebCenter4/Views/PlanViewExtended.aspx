<%@ Page language="c#" Codebehind="PlanViewExtended.aspx.cs" AutoEventWireup="false" Inherits="WebCenter4.Views.PlanViewExtended" %>
				...
				<table id="mainparametertable" style="border: 1px;text-align: left; width:inherit;" cellspacing="1" cellpadding="1">								   
                    ...
                    <tr id="imposition1">
                        <td style="width: 161px; height: 14px; white-space:nowrap;">
							<asp:Label id="lblImpositionSection1" runat="server" CssClass="LabelNormal">Section 1</asp:Label>
                        </td>
                        <td style="height: 14px; white-space:nowrap;" colspan="3">
							<telerik:RadComboBox id="ddImpositionList" runat="server" Width="300px" SkinsPath="~/RadControls/ComboBox/Skins" Skin="Default"></telerik:RadComboBox>	    									
                        </td>
					</tr>
                    <tr id="imposition2">
                        <td style="width: 161px; height: 14px; white-space:nowrap;">
							<asp:Label id="lblImpositionSection2" runat="server" CssClass="LabelNormal">Section 2</asp:Label>
                        </td>
                        <td style="height: 14px; white-space:nowrap;" colspan="3">
                    ...
                    <tr id="imposition3">
                        <td style="width: 161px; height: 14px; white-space:nowrap;">
							<asp:Label id="lblImpositionSection3" runat="server" CssClass="LabelNormal">Section 3</asp:Label>
                        </td>
                        <td style="height: 14px; white-space:nowrap;" colspan="3">
