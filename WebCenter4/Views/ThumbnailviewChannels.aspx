<%@ Page language="c#" Codebehind="ThumbnailviewChannels.aspx.cs" AutoEventWireup="false" Inherits="WebCenter4.Views.ThumbnailviewChannels" enableViewState="True" smartNavigation="False"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		<title>Thumbnail view channels</title>
		...
		<form id="Form1" method="post" runat="server" >
            <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                ...
                <Items>
                    ...
                    <telerik:RadToolBarButton runat="server" Value="InsertPages" Text="Insert pages" ToolTip=""  ImageUrl="../Images/insert16.gif" ImagePosition="Left" PostBack="true" >
                    </telerik:RadToolBarButton>
                    <telerik:RadToolBarButton runat="server" IsSeparator="True" Text="Sep">
                    </telerik:RadToolBarButton>
            ...
            <div id="mainDiv" style="overflow: auto;border: 0; background-color: #f0f8ff;width: 100%;">
			            ...
			            <asp:datalist style="Z-INDEX: 0" id="datalistImages" runat="server" BorderStyle="Groove" BackColor="#F0F4F8" BorderWidth="0px" Width="<%# nImageWidth %>" RepeatColumns="<%# nImagesPerRow %>" RepeatDirection="Horizontal" HorizontalAlign="Left" ShowHeader="False" CellPadding="0" CellSpacing="2" BorderColor="Transparent">				            
				            ...
				            <ItemTemplate>
								            <table id="TableThumb" runat="server" style="border:inset; border-color: #7a96df #b0c4de #6495ed #7a96df;padding:0px;border-spacing:0px;text-align: center;" width="<%# nImageWidth %>" align="center"  cellspacing="0" cellpadding="0">
									            <tr>
										            <td style="background: #f0f4f8; vertical-align: top;text-align:center;" align="center">
											            <asp:Panel id="pnlThumbnail" runat="server" Font-Names="Verdana" Font-Size="9pt"
												            Height="16" EnableViewState="False" Font-Bold="True" BorderWidth="0" BorderStyle="None">
                                                            ...
                                                            <input id="hiddenFileStatusLow" value='<%# DataBinder.Eval(Container.DataItem, "FileStatusLow") %>' type="hidden" name="hiddenFileStatusLow" runat="server"/>
											                <input id="hiddenFileStatusHigh" value='<%# DataBinder.Eval(Container.DataItem, "FileStatusHigh") %>' type="hidden" name="hiddenFileStatusHigh" runat="server"/>
                    						                <input id="hiddenFileStatusPrint" value='<%# DataBinder.Eval(Container.DataItem, "FileStatusPrint") %>' type="hidden" name="hiddenFileStatusPrint" runat="server"/>
                                                        </asp:Panel>
                                                    </td>
									            </tr>
									            <tr>
										            <td style="vertical-align: top;text-align:center;" align="center">
											            <asp:Panel id="pnlPlanPageName" runat="server" Font-Names="Verdana" Font-Size="7pt"
												            Height="16" EnableViewState="False" Font-Bold="False"  BorderWidth="0" BorderStyle="None">
									            ...
									            <tr>
										            <td style="background-color: #f0f4f8; vertical-align: top;text-align:center;" align="center">
                                                        <a href='ThumbnailviewChannels.aspx?<%# DataBinder.Eval(Container.DataItem, "ImageQueryString") %>'>
									            ...
									            <tr>
										            <td style="vertical-align: top;text-align:center;" align="center">
											            ...
											            <table id="Table9" style="width: 100%; border: none;" cellspacing="0" cellpadding="1">
												            <tr>
													            <td style="white-space:nowrap;text-align:center;" align="center">
														            <asp:ImageButton id="ImageButtonLow" runat="server" BackColor="Transparent" Height="16px" ImageUrl="../Images/LowNone.gif" CommandName="PDFlow" ToolTip="PDF lowres (RGB) status" ></asp:ImageButton>
                                                                </td>
        													    <td style="white-space:nowrap;text-align:center;" align="center">
														            <asp:ImageButton id="ImageButtonHigh" runat="server" BackColor="Transparent" Height="16px" ImageUrl="../Images/HighNone.gif" CommandName="PDFhigh"  ToolTip="PDF Highres (RGB) status"></asp:ImageButton>
                                                                </td>
													            <td style="white-space:nowrap;text-align:center;" align="center">
														            <asp:ImageButton id="ImageButtonPrint" runat="server" BackColor="Transparent" Height="16px"  ImageUrl="../Images/PrintNone.gif" CommandName="PDFPrint" ToolTip="PDF Print (CMYK) status"></asp:ImageButton>
													            </td>
    									            ...
    									            <tr>
											            ...
											            <table id="Table6" border="0" cellspacing="0" cellpadding="0" width="100%">
												            <tr>
                                                                ...
                                                                <td height="16" align="center">
														            <asp:imagebutton id="btnPDF" runat="server" BackColor="Transparent" Height="16" BorderWidth="0px" ImageUrl="../Images/pdf16.gif" CommandName="ViewPDF" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ImageNumber") %>' ToolTip="Click to view download file" Visible="False"></asp:imagebutton>
                                                                </td>
                         ...
                         <telerik:RadWindowManager id="RadWindowManager1" runat="server" Skin="Vista" RenderMode="Lightweight">
				            <Windows>
                               ...
                               <telerik:RadWindow runat="server" Height="230px" Width="250"  ID="radWindowKill" IconUrl="../Images/waste.gif"
								...
								VisibleStatusbar="False" Modal="True" Top="" Title="Retransmit to selected Channels"></telerik:RadWindow>

                                <telerik:RadWindow runat="server" Height="674px" Width="645px" ID="radWindowInsertPages"
								    Skin="Vista" DestroyOnClose="True" Left="" NavigateUrl="InsertPages.aspx" Behaviors="Close"
								    VisibleStatusbar="False" Modal="True" Top="" Title="Insert uploaded pages">
                                </telerik:RadWindow>


                                <telerik:RadWindow runat="server" Height="260px" Width="500"  ID="radWindowDownloadPDF"
								    Skin="Office2010Blue" DestroyOnClose="True" Left="" NavigateUrl="DownloadPDF.aspx" Behaviors="Close"
								    VisibleStatusbar="False" Modal="True" Top="" Title="Custom Action" ></telerik:RadWindow>
