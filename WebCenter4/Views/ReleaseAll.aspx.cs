...
{
    public partial class ReleaseAll : System.Web.UI.Page
    {
        ...
        protected void bntApply_Click(object sender, EventArgs e)
        {
            ...
            db.ReleaseAll(publicationID, pubDate, nEditionID, nSectionID, (string)Session["Username"], txtComment.Text, (bool)Session["LogApprove"], out errmsg);
