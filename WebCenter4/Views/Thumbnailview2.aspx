		...
		<form id="Form1" method="post" runat="server" >
            <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                ...
                <Items>
                    ...
                    <telerik:RadToolBarButton runat="server" Value="ReadyMessage" Text="Confirm ready" ToolTip="Confirm that all pages are ready"  ImageUrl="../Images/ready16.gif" ImagePosition="Left" PostBack="true" >
                    </telerik:RadToolBarButton>

                    <telerik:RadToolBarSplitButton runat="server" Text="Pages per row" Value="PagesPerRowSelector"  PostBack="true" EnableDefaultButton="True">
                        <Buttons>                            
            ...
            <div id="mainDiv" style="overflow: auto;border: 0; background-color: #f0f8ff;width: 100%;">
                <asp:label id="lblChooseProduct" runat="server" ForeColor="Teal" Font-Size="Larger">Choose a product in the tree</asp:label>			
			        <asp:datalist style="Z-INDEX: 0" id="datalistImages" runat="server" BorderStyle="Groove" BackColor="#F0F4F8" BorderWidth="0px" Width="<%# nImageWidth %>" RepeatColumns="<%# nImagesPerRow %>" RepeatDirection="Horizontal" HorizontalAlign="Left" ShowHeader="False" CellPadding="0" CellSpacing="2" BorderColor="Transparent">				            
				        ...
				        <ItemTemplate>
								<table id="TableThumb" style="border:inset; border-color: #7a96df #b0c4de #6495ed #7a96df;"  cellspacing="0" cellpadding="0" width="<%# nImageWidth %>" align="center" runat="server">
									<tr>
										<td style="background: #f0f4f8; vertical-align: top;text-align:center;">
											<asp:Panel id="pnlThumbnail" runat="server" Font-Names="Verdana" Font-Size="9pt"
											    ...
											    <input id="hiddenAlert"  value='<%# DataBinder.Eval(Container.DataItem, "Alert") %>' type="hidden" name="hiddenAlert" runat="server" />
											</asp:Panel>
                                        </td>
									</tr>
									<tr>
										<td style="vertical-align: top;text-align:center;">
											<asp:Panel id="pnlPlanPageName" runat="server" Font-Names="Verdana" Font-Size="7pt"
												Height="16" EnableViewState="False" Font-Bold="False" >
												<%# DataBinder.Eval(Container.DataItem, "ImageDesc3") %>
											</asp:Panel>
                                        </td>
									</tr>
									<tr>
										<td style="background-color: #f0f4f8; vertical-align: top;text-align:center;">
									    ...
									    <tr>
										<td style="vertical-align: top;text-align:center;">
											<asp:Panel id="pnlFooter" runat="server" Font-Names="Verdana" Font-Size="7pt" Height="16" EnableViewState="False">
									...
									<tr>
										<td style="vertical-align: top;text-align:center;" >
                                            <asp:Panel id="pnlFooter2" runat="server"  BorderWidth="0" BorderStyle="None">
											    ...
											    <table id="Table9" style="border:none;width:100%;padding:0px;border-collapse: collapse; border-spacing: 0px;" >
												    <tr>
    									...
    									<tr>
                                            ...
                                            <asp:Panel id="pnlFooter3" runat="server"  BorderWidth="0" BorderStyle="None">

											<table id="Table6"  border="0" cellspacing="0" cellpadding="0" width="100%">
												<tr>
													<td style="height:16px;" height="16" align="left">
														<asp:imagebutton id="btnColor" runat="server" BackColor="Transparent" Height="16" ImageUrl="../Images/Colorcmyk_Flat.gif" CommandName="Color" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ImageNumber") %>' ToolTip="Click to change color" ImageAlign="Middle"></asp:imagebutton>
                                                    </td>
													<td style="height:16px;" height="16" align="center">
														<asp:imagebutton id="btnPDF" runat="server" BackColor="Transparent" Height="16" BorderWidth="0px" ImageUrl="../Images/pdfsmall.gif" CommandName="ViewPDF" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ImageNumber") %>' ToolTip="Click to view download file" Visible="False"></asp:imagebutton>
                                                    </td>
													<td style="height:16px;" height="16" align="center">
                                                    ...
                                                    <td style="height:16px;" height="16" align="center">
														<asp:imagebutton id="btnUpload" runat="server" BackColor="Transparent" Height="16" BorderWidth="0px" ToolTip="Click to upload file" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ImageNumber") %>' CommandName="Upload" ImageUrl="../Images/upload.gif" Visible="False"></asp:imagebutton>
													</td>
                                                    <td style="height:16px;" height="16" align="center">
													...
													<td style="height:16px;" height="16" align="center">
                                                        ...
                                                        <td style="height:16px;" height="16" align="right">
														<table id="Table1" border="0" cellspacing="0" cellpadding="0" >
															<tr>
																<td style="white-space:nowrap;">
																	<asp:imagebutton id="btnLock" runat="server" BackColor="Transparent" Height="16" BorderWidth="0px" ImageUrl="../Images/lock.gif" CommandName="Lock" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ImageNumber") %>' ToolTip="Click to lock page" ></asp:imagebutton>
                                                                </td>
																<td style="white-space:nowrap;">
													...
													<td style="height:16px;width:34px;" height="16" width="34" align="right">
														<table id="Table8" border="0" cellspacing="0" cellpadding="0" width="34">
															<tr>
                                                                ...
                                                                <td style="white-space:nowrap;">
																	<asp:imagebutton id="btnResetApproval" runat="server" BackColor="Transparent" Height="16" BorderWidth="0px" ImageUrl="../Images/Resetapprove.gif" CommandName="Resetapprove" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ImageNumber") %>' ToolTip="Click to reset approval"></asp:imagebutton>
                                                                </td>
                         ...
                         <telerik:RadWindowManager id="RadWindowManager1" runat="server" Skin="Vista" RenderMode="Lightweight">
				            <Windows>
						        ...
						        <telerik:RadWindow runat="server" ID="radWindowPitstopReport" DestroyOnClose="True" Skin="Office2010Blue" 
							        Title="Preflight report" Width="800px" Height="600px" Modal="True" Behaviors="Close" Top=""
							        NavigateUrl="PitstopReportview.aspx" Left="" ShowContentDuringLoad="true" ></telerik:RadWindow>
						        <telerik:RadWindow runat="server" ID="radWindowAlwanReport" DestroyOnClose="True" Skin="Office2010Blue" 
							        Title="Inksave report" Width="800px" Height="600px" Modal="True" Behaviors="Close" Top=""
							        NavigateUrl="AlwanReportview.aspx" Left="" ShowContentDuringLoad="true"></telerik:RadWindow>
                                ...
                                <telerik:RadWindow runat="server" Height="230px" Width="500"  ID="radWindowUploadFile"
                               ...
                               <telerik:RadWindow runat="server" Height="230px" Width="250"  ID="radWindowKill" IconUrl="../Images/waste.gif"
                               ...
                               <telerik:RadWindow runat="server" Height="500px" Width="500" ID="radWindowRetransmitLocations"
								Skin="Office2010Blue" DestroyOnClose="True" Left="" NavigateUrl="RetransmitLocations.aspx" Behaviors="Close"
								VisibleStatusbar="False" Modal="True" Top="" Title="Retransmit to selected Locations"></telerik:RadWindow>
                                ...
                                <telerik:RadWindow runat="server" Height="260px" Width="500"  ID="radWindowReadyAction"
								Skin="Office2010Blue" DestroyOnClose="True" Left="" NavigateUrl="ReadyAction.aspx" Behaviors="Close"
								VisibleStatusbar="False" Modal="True" Top="" Title="Report pages ready" ></telerik:RadWindow>
                                <telerik:RadWindow runat="server" Height="610px" Width="600"  ID="radWindowUploadFiles"
							        Skin="Office2010Blue" DestroyOnClose="True" Left="" NavigateUrl="UploadFiles.aspx" Behaviors="Close" VisibleStatusbar="False"
							        Modal="True" Top="" Title="Upload PDF files"  ></telerik:RadWindow>
