<%@ Page language="c#" Codebehind="PlanViewExtendedXML.aspx.cs" AutoEventWireup="false" Inherits="WebCenter4.Views.PlanViewExtendedXML" validateRequest="false" %>
            ...
            <asp:panel id="PanelAddPlan" runat="server" Width="500" HorizontalAlign="Left" Wrap="False" >                               
				<table id="mainparametertable" style="border: 1px;text-align: left; width:inherit;margin-left:20px;" cellspacing="1" cellpadding="1" >								   
					...
					<tr id="edition">
						...
						<td style="white-space:nowrap;" >										
                            <telerik:RadComboBox id="ddEditionList" runat="server" Width="100px" AutoPostBack="True" SkinsPath="~/RadControls/ComboBox/Skins" Skin="Default"></telerik:RadComboBox>	    									
                        </td>
                        <td></td>
                    </tr>
					...
					<tr id="section1">
                        <td style="height: 14px; white-space:nowrap;">
	    					<asp:Label id="lblSection1" runat="server" CssClass="LabelNormal">Section 1: Number of pages</asp:Label>
                        </td>
						 <td style="height: 14px; white-space:nowrap;">									
                            ...
                            <telerik:RadComboBox id="RadComboBoxPagecount1" runat="server" Width="100px" AutoPostBack="False" SkinsPath="~/RadControls/ComboBox/Skins" Skin="Default"></telerik:RadComboBox>	    									
                      </td>
                        <td>
                       </td>		    							
                    </tr>
					<tr id="section2">
                        <td style="height: 14px; white-space:nowrap;">
	    					<asp:Label id="lblSection2" runat="server" CssClass="LabelNormal">Section 2: Number of pages</asp:Label>
                        </td>		    
                         <td style="height: 14px; white-space:nowrap;">								
                            ...
                            <telerik:RadComboBox id="RadComboBoxPagecount2" runat="server" Width="100px" AutoPostBack="False" SkinsPath="~/RadControls/ComboBox/Skins" Skin="Default"></telerik:RadComboBox>	    									
                        </td>  							
                        <td >
                        </td>		    							
                  </tr>
					<tr id="section3">
                        <td style="height: 14px; white-space:nowrap;">
	    					<asp:Label id="lblSection3" runat="server" CssClass="LabelNormal">Section 3: Number of pages</asp:Label>
                        </td>		    							
 						 <td style="height: 14px; white-space:nowrap;">							
                          ...
                          <telerik:RadComboBox id="RadComboBoxPagecount3" runat="server" Width="100px" AutoPostBack="False" SkinsPath="~/RadControls/ComboBox/Skins" Skin="Default"></telerik:RadComboBox>	    									
                       </td>
                        <td>
                      </td>		    							
                    ...
                    <tr id="filename">
						...
						<td style="white-space:nowrap;" colspan="2" >
                            <telerik:RadTextBox ID="txtFilename" runat="server" Width="200px"></telerik:RadTextBox>										
                        </td>
